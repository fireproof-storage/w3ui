  ...
  return (
    <div className="flex flex-col items-center space-y-12 pt-12">
      <div className="flex flex-col items-center space-y-4">
        ...
        <p>Click the button below to register this space and start uploading.</p>
      </div>
      <div className="flex flex-col items-center space-y-4">
        {submitted ? (
          <Loader className="w-6" />
        ) : (
          <button className="w3ui-button" onClick={onSubmit}>
            Register Space
          </button>
        )}
      </div>
...
export function SpaceEnsurer({ children }: { children: JSX.Element | JSX.Element[] }): JSX.Element {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen">
      <div className="text-gray-200 text-center">
        ...
        <p>To get started with w3up you'll need to create a space.</p>
        <p>Give it a name and hit create!</p>
...
export default function Home(): JSX.Element {
  ...
  const fp = useFireproof(((database: any) => {window.fireproof = database}))
