  ...
  return (
    <>
      ...
      <div className="flex min-h-full w-full">
        <nav className="flex-none w-64 bg-gray-900 text-white pb-4 border-r border-gray-800 h-screen">
          <div className="flex flex-col justify-between h-full">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="flex flex-row space-x-2">
                <a className="text-xs block text-center mt-2" href="/terms">
                  Terms
                </a>
                <a className="text-xs block text-center mt-2" href="/docs">
                  Docs
                </a>
                <a className="text-xs block text-center mt-2" href="https://github.com/web3-storage/w3ui/issues">
                  Support
                </a>
              </div>
            </div>
